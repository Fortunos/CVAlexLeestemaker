	...
	*/
	...
	public override void OnInspectorGUI () {
		...
		if(fRange < 360f){
			...
			EditorGUILayout.IntSlider(segments, 5, 2000, new GUIContent("Segments","Quantity of line segments is used for build mesh render of 2DLight. 5 at least in spot Lights"));
		}else{
			EditorGUILayout.IntSlider(segments, 3, 2000, new GUIContent("Segments","Quantity of line segments is used for build mesh render of 2DLight. 3 at least"));
		}
